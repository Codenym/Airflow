select trim(form_id_number)                                                          as form_id_number,
       ...
       trim(ein)                                                                     as ein,
       upper(replace(trim(contributor_name), '  ', ' '))                             as contributor_name,
       upper(replace(trim(contributor_address_1), '  ', ' '))                        as contributor_address_1,
       upper(replace(trim(contributor_address_2), '  ', ' '))                        as contributor_address_2,
       upper(replace(trim(contributor_address_city), '  ', ' '))                     as contributor_address_city,
       upper(replace(trim(contributor_address_state), '  ', ' '))                    as contributor_address_state,
       ...
       upper(replace(trim(contributor_employer), '  ', ' '))                         as contributor_employer,
       (contribution_amount ::numeric)                                               as contribution_amount,
       upper(replace(trim(contributor_occupation), '  ', ' '))                       as contributor_occupation,
